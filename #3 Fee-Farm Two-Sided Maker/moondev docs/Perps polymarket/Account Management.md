...
<Tabs>
  ...
  <Tab title="API">
    ...
    `fee_tier` is the account's current fee tier: a zero-based index into the
    `tiers` of the fee schedule from [Trading Fees](/perps/trading#trading-fees).
    Accounts without a current tier assignment report `0`.
  </Tab>
</Tabs>
