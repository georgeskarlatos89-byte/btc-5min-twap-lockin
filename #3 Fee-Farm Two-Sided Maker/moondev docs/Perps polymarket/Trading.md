...
[Default Leverage and Margin Mode](/perps/learn-about-trading/margin#default-leverage-and-margin-mode)
...
[Fees](/perps/learn-about-trading/fees) for the tier table. Authenticated
portfolio reads report the account's current tier; see
[Portfolio](/perps/account-management#portfolio).
...
<Tabs>
  ...
  <Tab title="API">
    ...
    <Accordion title="Output: FeesInfo">
      ```json theme={null}
      {
        "fee_schedule": [
          {
    ...
    your authenticated [portfolio](/perps/account-management#portfolio) to read
