...
> Retrieves a specific order by its ID (order hash) for the authenticated user, including canceled or fully matched orders.
  ...
  /data/order/{orderID}:
    get:
      ...
      description: >
        ...
        user, including canceled or fully matched orders.
