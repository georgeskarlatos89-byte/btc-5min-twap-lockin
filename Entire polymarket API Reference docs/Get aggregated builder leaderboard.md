...
> **Data API v2:** this route has a v2 counterpart, `GET /v2/builders/leaderboard`. See [Migrating to Data API v2](/api-reference/data-api/migrating-from-v1).
    ...
    get:
      ...
      description: >-
        **Data API v2:** this route has a v2 counterpart, `GET
        /v2/builders/leaderboard`. See [Migrating to Data API
